...
TELEGRAM_BOT_TOKEN = '8147144508:AAEZjvEEH_KX1qDI18D7ieJz54zAcm3My6Q'
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*💬 Owner: @AVxAAYU*\n"
        "*📢 Channel: [AAYUxDDOS 24*7 Channel](https://t.me/+a70zRbaqLa40MWU9)*"
    )
...
async def help_command(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*3. Contact the bot owner @AVxAAYU for assistance or clarifications.*\n\n"
        "*⚡ Owner: @AVxAAYU*\n"
        "*📢 Channel: [AAYUxDDOS 24*7 Channel](https://t.me/+a70zRbaqLa40MWU9)*"
    )
    await context.bot.send_message(chat_id=chat_id, text=message, parse_mode='Markdown')
...
async def approve(update: Update, context: CallbackContext):
    ...
    if chat_id != ADMIN_USER_ID:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ You need to get permission to use this command. Contact @AVxAAYU.*", parse_mode='Markdown')
        return
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in users:
        await context.bot.send_message(chat_id=chat_id, text="*🤡 You need to get permission to use this bot. Contact owner @AVxAAYU.*", parse_mode='Markdown')
        return
